  ...
  <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        <vee-form class="space-y-6" action="#" method="POST" :validation-schema="loginSchema" @submit="login">
          <div>
          ...
          <div>
            ...
            <div class="mt-1">
              <vee-field id="password" name="password" type="password" autocomplete="current-password" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
        ...
        <div class="mt-6">
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              ...
              <a href="/#/signup" class="w-full inline-flex justify-center text-sm font-medium text-indigo-600 cursor-pointer">
                Register
              </a>
          <div class="mt-6 ">
          </div>
